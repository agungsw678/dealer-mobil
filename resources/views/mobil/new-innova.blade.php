        ...
        <div class="col-lg-9">
            ...
            <div id="mainSlider" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner shadow-sm">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/NewInnova.png') }}"
                            class="d-block w-100"
                            style="height:520px; object-fit:cover;"
                            alt="Toyota New Innova">
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 rounded-0"
                ...
                <div class="card-body" style="padding:25px 30px;">
                    ...
                    <p class="fs-6 text-dark lh-base mb-1">
                        ...
                        New Innova 2026 Solo Raya Jawa Tengah.<br>
                    ...
                    ['Kredit mulai', 'Rp 78 Jutaan Jutaan'],
                    ...
                    <div style="padding:6px 0;">
                        ...
                        <div style="color:#1a237e; font-size:.95rem; margin-top:4px;">
                            Anti Korosi, Paket Care Protera, Kotak Lipat, Pelindung Gagang, Kaca Film, Alas Kabin, Layanan Servis
                        </div>
                    </div>
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12;">
                ...
                <h3 style="font-weight:700; color:#333; font-size:18px;">
                    <span style="border-left:3px solid #33ccff; padding-left:7px;">
                        PILIHAN WARNA NEW INNOVA
                    </span>
                </h3>

                @php
                $warna = [
                ['gambar'=>'WarnaInnova.png','nama'=>'Warna Super White Two Pu...','caption'=>'Warna Super White Two Putih Toyota New Innova Solo Raya Jawa Tengah'],
                ['gambar'=>'WarnaInnova1.png','nama'=>'Warna Silver Metallic Toy...','caption'=>'Pilihan Warna Silver Metallic Toyota New Innova Solo Raya Jawa Tengah'],
                ['gambar'=>'WarnaInnova2.png','nama'=>'Warna Dark Gray Mica Met...',
                'caption'=>'Warna Phantom Brown Toyota New Innova Solo Raya Jawa Tengah'],
                ['gambar'=>'WarnaInnova3.png','nama'=>'Warna Phantom Brown Toy... ','caption'=>'Warna Phantom Brown Toyota New Innova Solo Raya Jawa Tengah'],
