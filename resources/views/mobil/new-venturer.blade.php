    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div id="mainSlider" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner shadow-sm">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/NewVenturer.png') }}"
                            class="d-block w-100"
                            style="height:480px; object-fit:contain; object-position:center top;"
                            alt="Toyota New Venturer">
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 rounded-0"
                style="margin-top:-50px; background:#f1f1f1; border-top:4px solid #33ccff;">
                ...
                <div class="card-body" style="padding:25px 30px;">
                    ...
                    <p class="fs-6 text-dark lh-base mb-1">
                        Informasi Pembelian, Test Drive, Simulasi Kredit Mobil Baru New Venturer 2026 Surabaya Raya Jawa Timur.<br>
                    ...
                    @php
                    $items = [
                    ['Harga mulai', 'Rp 536.893.000'],
                    ['Kredit mulai', 'Rp 121 Jutaan'],
                    ['Cicilan mulai', 'Rp 6 Jutaan'],
            ...
            <div style="margin-top:15px; background:#e9ecef; border-radius:12px; padding:0; border:1px solid #d6d6d6; overflow:hidden;">
                ...
                <div style="padding:24px; font-size:16px; line-height:1.6; color:#5f6f7f; background:white;">
                    Informasi daftar harga diatas merupakan harga mobil baru Toyota New Venturer yang sudah OTR ( On The Road ) Belum Dikurangi Cashback yang berlaku di Surabaya Raya Jawa Timur.</b>
                        ...
                        <div class="col-md-6">
                            <div class="toyota-card">
                                ...
                                <ul class="toyota-list">
                                    ...
                                    <li class="link">
                                        <a href="{{ route('mobil.yaris') }}">Lihat Selengkapnya</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
