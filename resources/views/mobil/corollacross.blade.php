        ...
        <div class="col-lg-9">
            ...
            <div class="card border-0 rounded-0"
                ...
                <div class="card-body" style="padding:25px 30px;">
                    ...
                    <h3 style="font-weight:700; color:#333333; font-size:22px; margin-bottom:10px;font-size:18px;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;">
                            TOYOTA NEW COROLLA CROSS
                        </span>
                    </h3>
                    ...
                    <div style="padding:6px 0;">
                        ...
                        <div style="color:#1a237e; font-size:.95rem; margin-top:4px;">
                            Anti Karat, Car Care Kit Protera, Collabsible Box, Handle Protect, Kaca Film, Karpet Dasar, Paket Servis
                        </div>
                    </div>
            ...
            <div style="margin-top:15px; background:#e9ecef; border-radius:12px; padding:0; border:1px solid #d6d6d6; overflow:hidden;">
                ...
                <div style="padding:18px 24px; background:white;font-size:18px;">
                    <h2 style="margin:0; font-size:22px; font-weight:700; color:#2c3e50;font-size:18px;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;">
                            DAFTAR HARGA NEW COROLLA CROSS
                        </span>
                    </h2>
                </div>
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12px;">
                ...
                @php
                $warna = [
                ['gambar'=>'Eksterior1.png', 'caption'=>'Eksterior Depan Toyota Corolla Cross Turquoise Metallic Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'Eksterior2.png', 'caption'=>'Eksterior Depan Toyota New Corolla Cross Turquoise Metallic Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'Eksterior3.png', 'caption'=>'Eksterior Samping Toyota New Corolla Cross Turquoise Metallic Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'Eksterior4.png', 'caption'=>'Eksterior Belakang Toyota New Corolla Cross Turquoise Metallic Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'Eksterior5.png', 'caption'=>'Eksterior Belakang Toyota New Corolla Cross Turquoise Metallic Black Top Surabaya Raya Jawa Tengah'],
                ];
                @endphp
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12;">
                ...
                @php
                $warna = [
                ['gambar'=>'Interior1.png','caption'=>'New Comfortable Full Dashboard Interior All Corolla Cross Surabaya Raya Jawa Tengah'],
                ['gambar'=>'Interior2.png','caption'=>'New Integrated 9-inch HeadUnit All New Corolla Cross Solo Raya Jawa Tengah'],
                ['gambar'=>'Interior3.png','caption'=>'New Rear-Seat Entertainment All New Corolla Cross Solo Raya Jawa Tengah'],
                ['gambar'=>'Interior4.png','caption'=>'New Wireless Charger All New Corolla Cross Solo Raya Jawa Tengah'],
                ['gambar'=>'Interior5.png','caption'=>'New Advanced 7-inch Digital TFT MID All New Corolla Cross Solo Raya Jawa Tengah'],
                ['gambar'=>'Interior6.png','caption'=>'New Spacious Cabin with New Long Sofa Mode All New Corolla Cross Solo Raya Jawa Tengah'],
                ];
                @endphp
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12;">
                ...
                <h3 style="font-weight:700; color:#333; font-size:18px;">
                    <span style="border-left:3px solid #33ccff; padding-left:7px;">
                        PILIHAN WARNA NEW COROLLA CROSS
                    </span>
                </h3>

                @php
                $warna = [
                ['gambar'=>'PilihanWarna1.png','nama'=>'Warna Turquoise Metallic','caption'=>'Pilihan Warna Turquoise Metallic Solo Raya Jawa Tengah'],
                ['gambar'=>'PilihanWarna2.png','nama'=>'Warna Yellow Black Top','caption'=>'Pilihan Warna Yellow Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'PilihanWarna3.png','nama'=>'Warna Red Black Top','caption'=>'Pilihan Warna Red Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'PilihanWarna5.png','nama'=>'Warna Silver Metallic Black Top ','caption'=>'Pilihan Warna Silver Metallic Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'PilihanWarna6.png','nama'=>'Warna Turquoise Metallic','caption'=>'Pilihan Warna Turquoise Metallic Solo Raya Jawa Tengah'],
                ];
                @endphp
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:10px;">
                ...
                <div class="ratio ratio-16x9 mb-3">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/Miek9Fe1YRM?autoplay=1&mute=1&rel=0"
    ...
    ">
            ...
            <div class="card mt-2 shadow-sm" style="border-radius:14px;background:#ffffff;">
                <div class="card-body spec-box">
                    ...
                    <h3 style="font-weight:700; color:#333;font-size:18px;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;">
                            REVIEW SPESIFIKASI TOYOTA COROLLA CROSS
                        </span>
                    </h3>

                    <p class="spec-text">
                        Toyota Corolla Cross merupakan SUV modern yang memadukan kenyamanan,
                        performa, serta efisiensi bahan bakar dengan teknologi hybrid terkini.
                        Dirancang untuk penggunaan harian maupun perjalanan jauh dengan kabin
                        luas dan fitur lengkap.
                    </p>

                    <p class="spec-subtitle">
                        Performa Mesin Toyota Corolla Cross:
                    </p>

                    <ul class="spec-list">
                        <li>Pilihan Mesin</li>
                        <li class="no-dot">
                            1. Bensin 1.8L 4 Silinder DOHC Dual VVT-i (Hybrid System)
                        </li>
                    </ul>
                    ...
                    <div id="specDetail" class="spec-detail">
                        ...
                        <!-- EKSTERIOR -->
                        <h6 class="spec-subtitle mt-3">Eksterior Toyota Corolla Cross</h6>
                        <ul class="spec-list">
                            <li>LED Headlamp with DRL</li>
                            <li>Auto Light Control System</li>
                            <li>Front Grille Stylish Design</li>
                            <li>Power Retractable Side Mirror with Turn Signal</li>
                            <li>Shark Fin Antenna</li>
                            <li>Rear Spoiler with High Mount Stop Lamp</li>
                            <li>Alloy Wheel 17-inch / 18-inch</li>
                            <li>Rear Wiper</li>
                            <li>Roof Rail (tipe tertentu)</li>
                        </ul>

                        <!-- DIMENSI -->
                        <h6 class="spec-subtitle mt-3">Dimensi</h6>
                        <ul class="spec-list">
                            <li>Panjang: ±4460 mm</li>
                            <li>Lebar: ±1825 mm</li>
                            <li>Tinggi: ±1620 mm</li>
                            <li>Wheelbase: ±2640 mm</li>
                            <li>Ground Clearance: ±165 mm</li>
                            <li>Turning Radius: ±5.2 m</li>
                            <li>Velg & Ban: 215/60 R17 / 225/50 R18</li>
                        </ul>

                        <!-- INTERIOR -->
                        <h6 class="spec-subtitle mt-3">Interior Toyota Corolla Cross</h6>
                        <ul class="spec-list">
                            <li>Premium Cabin Interior</li>
                            <li>Digital TFT MID Display</li>
                            <li>9-inch Touchscreen Head Unit (Bluetooth, USB, Smartphone Connectivity)</li>
                            <li>Audio Steering Switch</li>
                            <li>Dual Zone Automatic AC</li>
                            <li>Rear AC Vent</li>
                            <li>Electric Parking Brake & Brake Hold</li>
                            <li>Smart Entry & Push Start Button</li>
                            <li>Tilt & Telescopic Steering Wheel</li>
                            <li>Leather Seat (tipe tertentu)</li>
                            <li>Rear Seat 60:40 Split Folding</li>
                        </ul>

                        <!-- KESELAMATAN -->
                        <h6 class="spec-subtitle mt-3">Keselamatan</h6>
                        <ul class="spec-list">
                            <li>Toyota Safety Sense (TSS)</li>
                            <li>Pre-Collision System (PCS)</li>
                            <li>Lane Departure Alert (LDA)</li>
                            ...
                            <li>Airbags (Depan, Samping, Curtain)</li>
                            <li>Isofix & Tether Anchor</li>
                        </ul>
