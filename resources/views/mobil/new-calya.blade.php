...
<div class="container mt-3">
        ...
        <div class="col-lg-9">
            ...
            <div id="mainSlider" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner shadow-sm">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/NewCalya.png') }}"
                            class="d-block w-100"
            ...
            <div class="card border-0 rounded-0"
                ...
                <div class="card-body" style="padding:25px 30px;">
                    ...
                    @php
                    $items = [
                    ['Harga mulai', 'Rp 173.363.000'],
                    ['Kredit mulai', 'Rp 38 Jutaan'],
                    ...
                    <div id="detailDeskripsi" style="display:none;">
                        <p style="font-size:.9rem; color:#555; line-height:1.5;">
                            ...
                            Syarat dan Ketentuan berlaku di wilayah Solo, Boyolali, Sukoharjo, Karanganyar, Wonogiri, Sragen, Jawa Timur
                        </p>
                    </div>
            ...
            {{-- PILIHAN WARNA --}}
            <div class="card mt-4 shadow-sm p-4" style="background:white; border-radius:12;">

                <h3 style="font-weight:700; color:#333; font-size:18px;">
                    <span style="border-left:3px solid #33ccff; padding-left:7px;">
                        PILIHAN WARNA NEW CALYA
                    </span>
                </h3>

                @php
                $warna = [
                ['gambar'=>'NewCalya2.png','nama'=>'Warna White Toyota Calya','caption'=>'Warna White Toyota Calya Solo Raya Jawa Tengah'],
                ['gambar'=>'NewCalya3.png','nama'=>'Warna Orange Metallic To...','caption'=>'Warna Orange Metallic Toyota New Calya Solo Raya Jawa Tengah'],
                ['gambar'=>'NewCalya4.png','nama'=>'Warna Red Toyota New Calya','caption'=>'Warna Red Toyota New Calya Solo Raya Jawa Tengah'],
                ['gambar'=>'NewCalya5.png','nama'=>'Warna Silver Metallic Toy...','caption'=>'Warna Silver Metallic Toyota New Calya Solo Raya Jawa Tengah'],
                ['gambar'=>'NewCalya6.png','nama'=>'Warna Black Toyota New Cal...','caption'=>'Warna Black Toyota New Calya SoloRaya Jawa Tengah'],
                ['gambar'=>'NewCalya7.png','nama'=>'Warna Bronze Mica Metallic','caption'=>'Warna Bronze Mica Metallic Toyota New Calya Solo Raya Jawa Tengah'],
                ['gambar'=>'NewCalya8.png','nama'=>'Warna Blue Toyota New Ca...','caption'=>'Warna Blue Toyota New Calya Solo Raya Jawa Tengah'],
                ];
                @endphp
            ...
            {{-- Bagian Video Blog --}}
            <div class="card mt-4 shadow-sm p-4" style="background:white; border-radius:10px;">
                <h3 style="font-weight:700; color:#333; font-size:18px;">
                    <span style="border-left:3px solid #33ccff; padding-left:7px;font-size:18px;">
                        BLOG VIDEO NEW CALYA
                    </span>
                </h3>
                ...
                <div class="ratio ratio-16x9 mb-3">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/6RJi7LKqJRo?autoplay=1&mute=1&rel=0"
                ...
                @php
                $videos = [
                ['id'=>'6RJi7LKqJRo','title'=>'Alasan Toyoya New Calya Bisa Sangat Laku'],
                ['id'=>'bHV8st2EW1c','title'=>'Fitur Unik Toyota New Calya Review by Carmudi'],
                ['id'=>'72JkN76OqfQ','title'=>'Review Toyota New Calya Facelift by CVT Indonesia'],
                ];
                @endphp
    ...
    ">
            ...
            <div class="card mt-4 shadow-sm" style="border-radius:14px;background:#ffffff;">
                <div class="card-body spec-box">
                    ...
                    <h4 style="font-weight:700; color:#333; font-size:18px;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;font-size:18px;">
                            REVIEW SPESIFIKASI NEW CALYA
                        </span>
                    </h4>

                    <p class="spec-text">
                        Toyota Calya kini hadir dengan penyegaran terbaru melalui facelift yang memberikan tampilan eksterior lebih modern,
                        interior lebih nyaman, serta fitur yang semakin lengkap untuk menunjang aktivitas keluarga.
                        Mobil MPV 7 penumpang ini dikenal sebagai kendaraan yang sangat diminati di Indonesia karena memiliki
                        value for money yang tinggi dan penjualan mencapai sekitar 60 ribu unit per tahun.
                    </p>

                    <p class="spec-subtitle">
                        Performa Mesin Toyota New Calya:
                    </p>

                    <ul class="spec-list">
                        <li>Mesin 1197cc 3NR 4 Silinder, DOHC 16 Valves, Dual VVT-i dan Drive by Wire</li>
                        <li class="no-dot">Tenaga Maksimum 88 PS @ 6000 rpm</li>
                        <li class="no-dot">Torsi Maksimum 110 Nm @ 4200 rpm</li>
                        <li class="no-dot">Transmisi Manual 5-Speed atau Automatic</li>
                        <li class="no-dot">Bahan Bakar Bensin minimal beroktan 95</li>
                    </ul>
                    ...
                    <div id="specDetail" class="spec-detail">
                        ...
                        <!-- EKSTERIOR -->
                        <h6 class="spec-subtitle mt-3">Eksterior Toyota New Calya</h6>
                        <ul class="spec-list">
                            <li>New Front Grille Design with Dark Chrome Element</li>
                            <li>Dark Chrome Element pada Backdoor Garnish</li>
                            <li>LED Headlamp</li>
                            <li>Lampu Sein</li>
                            <li>Auto Cut-Off Lampu</li>
                            <li>Wiper Otomatis</li>
                            <li>Spion Retractable Otomatis (Tipe G)</li>
                            <li>Ukuran Ban 175/65R14</li>
                            <li>Pelek 14 Inch Two-Tone Machining Alloy</li>
                        </ul>
                        ...
                        <ul class="spec-list">
                            ...
                            <li>Lebar: 1655 mm</li>
                            <li>Tinggi: 1600 mm</li>
                            <li>Wheelbase: 2525 mm</li>
                            <li>Kapasitas Tangki Bahan Bakar: 36 Liter</li>
                        </ul>

                        <!-- INTERIOR -->
                        <h6 class="spec-subtitle mt-3">Interior Toyota New Calya</h6>
                        <ul class="spec-list">
                            <li>Dashboard dan Kursi Nuansa Dark Brown</li>
                            <li>Touchscreen Head Unit Audio & Video</li>
                            <li>Bluetooth, USB, DVD/CD Player, MP3, AUX</li>
                            <li>iPhone & iPad Connection</li>
                            <li>Audio Steering Switch (Tipe G)</li>
                            <li>Under Seat Compartment Tray (Tipe G AT)</li>
                            <li>Illumination Indicator (Tipe G AT)</li>
                            <li>Driver Seat Pocket</li>
                            <li>Front Console Box</li>
                        </ul>
                        ...
                        <ul class="spec-list">
                            ...
                            <li>3 Point Seatbelt</li>
                            <li>ISOFIX</li>
                            <li>Anti-Theft System</li>
                            <li>Anti-Lock Braking System (ABS) (kecuali tipe E Non ABS)</li>
                            <li>AC Pendingin Interior</li>
                            <li>Auto Air Circulator</li>
                            <li>Alarm Panic Mode</li>
                        </ul>

                        <!-- DISCLAIMER -->
                        <p class="spec-disclaimer mt-4">
                            <strong>Disclaimer:</strong> Tidak semua fitur Toyota New Calya ditampilkan pada halaman ini.
                            Untuk informasi lebih lengkap mengenai spesifikasi, harga, dan promo terbaru silakan
                            menghubungi marketing Toyota melalui kontak yang tersedia di website ini.
                        </p>
            ...
            {{-- Galeri Delivery --}}
            <div class="card mt-4 shadow-sm p-4" style="background:white; border-radius:12px;">
                ...
                <div style="display:flex; gap:10px; overflow-x:auto; padding-top:10px;">
                    ...
                    <div style="min-width:200px; border-radius:0;">
                        <img
                            src="{{ asset('images/'.$w['gambar']) }}"
                            data-full="{{ asset('images/'.$w['gambar']) }}"
                            data-caption="New Comfortable Full Dashboard Eksterior All New Calya - Solo Raya Jawa Timur"
                            class="open-lightbox"
            ...
            <div class="card mt-4 shadow-sm" style="border-radius:14px; background:#ffffff;">
                <div class="card-body" style="padding:26px 28px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="toyota-card">
                                <img src="{{ asset('images/New Calya.png') }}" class="img-fluid">
