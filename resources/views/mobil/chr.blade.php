    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div id="mainSlider" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner shadow-sm">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/BG-C-HR.png') }}"
                            class="d-block w-100"
            ...
            <div class="card border-0 rounded-0"
                style="margin-top:-6px; background:#f1f1f1; border-top:3px solid #33ccff;">

                <div class="card-body" style="padding:25px 30px;">

                    <h3 style="font-weight:700; color:#333333; font-size:22px; margin-bottom:10px;">
                    ...
                    <div style="padding:6px 0;">
                        ...
                        <div style="color:#1a237e; font-size:.95rem; margin-top:4px;">
                            Anti Karat Mantap, Car Care Bikin Kinclong, Kaca Film Adem Banget, Karpet Dasar Rapi Clean, Paket Servis Anti Ribet
                        </div>
                    </div>
            ...
            <div style="margin-top:15px; background:white; border-radius:12px; padding:0; border:1px solid #d6d6d6; overflow:hidden;">

                <!-- Judul -->
                <div style="padding:18px 24px; background:white;">
                    <h2 style="margin:0; font-size:22px; font-weight:700; color:#2c3e50;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;font-size:18px;">
                            DAFTAR HARGA NEW C-HR
                        </span>
                    </h2>
                </div>
                ...
                <div style="padding:24px; font-size:16px; line-height:1.6; color:#5f6f7f; background:white;">
                    Informasi daftar harga diatas merupakan harga mobil baru Toyota New C-HR yang sudah OTR
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12;">
                ...
                @php
                $warna = [
                ['gambar'=>'C-HR13.png','nama'=>'Warna Turquoise Metallic','caption'=>'Warna Turquoise Metallic Solo Raya Jawa Tengah'],
                ['gambar'=>'C-HR14.png','nama'=>'Warna Yellow Black Top','caption'=>'Warna Yellow Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'C-HR15.png','nama'=>'Warna Red Black Top','caption'=>'Warna Red Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'C-HR16.png','nama'=>'Warna White Black Top','caption'=>'Warna White Black Top Solo Raya Jawa Tengah'],
                ['gambar'=>'C-HR17.png','nama'=>'Warna Silver Metallic Black Top ','caption'=>'Warna Silver Metallic Black Top Solo Raya Jawa Tengah'],
                ];
                @endphp
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:10px;">
                ...
                <div class="ratio ratio-16x9 mb-3">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/cs6OvHZMZhY?autoplay=1&mute=1&rel=0"
            ...
            <div class="card mt-2 shadow-sm" style="border-radius:14px;background:white;">
                <div class="card-body spec-box">
                    ...
                    <h3 style="font-weight:700; color:#333;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;font-size:18px;">
                            REVIEW SPESIFIKASI TOYOTA C-HR
                        </span>
                    </h3>

                    <p class="spec-text">
                        Toyota C-HR merupakan SUV kompak bergaya sporty dan futuristik yang dirancang
                        untuk pengendara urban. Memadukan desain agresif, kenyamanan berkendara,
                        serta teknologi modern untuk mendukung mobilitas harian.
                    </p>
                    ...
                    <div id="specDetail" class="spec-detail">
                        ...
                        <!-- EKSTERIOR -->
                        <h6 class="spec-subtitle mt-3">Eksterior Toyota C-HR</h6>
                        <ul class="spec-list">
                            <li>LED Headlamp with Daytime Running Light (DRL)</li>
                            <li>Auto Light Control System</li>
                            <li>Front & Rear LED Combination Lamp</li>
                            <li>Bold Front Grille with Sporty Bumper Design</li>
                            <li>Power Adjustable Side Mirror with Turn Signal</li>
                            <li>Shark Fin Antenna</li>
                            <li>Rear Spoiler with High Mount Stop Lamp</li>
                            <li>Velg Alloy 17-inch Sporty Design</li>
                            <li>Rear Wiper</li>
                        </ul>
                        ...
                        <ul class="spec-list">
                            <li>Panjang: ±4390 mm</li>
                            <li>Lebar: ±1795 mm</li>
                            <li>Tinggi: ±1565 mm</li>
                            <li>Wheelbase: ±2640 mm</li>
                            <li>Ground Clearance: ±160 mm</li>
                            <li>Turning Radius: ±5.2 m</li>
                            <li>Velg & Ban: 215/60 R17 Alloy Wheel</li>
                        </ul>

                        <!-- INTERIOR -->
                        <h6 class="spec-subtitle mt-3">Interior Toyota C-HR</h6>
                        <ul class="spec-list">
                            <li>Sporty Cabin Interior with Premium Material</li>
                            <li>Digital TFT MID Display</li>
                            <li>8-inch Touchscreen Head Unit (Bluetooth, USB, Smartphone Connectivity)</li>
                            <li>Audio Steering Switch</li>
                            <li>Dual Zone Automatic AC</li>
                            <li>Electric Power Window with Jam Protection</li>
