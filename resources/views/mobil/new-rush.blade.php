        ...
        <div class="col-lg-9">
            ...
            <div id="mainSlider" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner shadow-sm">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/NewRush.png') }}"
                            class="d-block w-100"
            ...
            <div class="card border-0 rounded-0"
                ...
                <div class="card-body" style="padding:25px 30px;">
                    ...
                    @php
                    $items = [
                    ['Harga mulai', 'Rp 295.939.000'],
                    ['Kredit mulai', 'Rp 59 Jutaan'],
                    ['Cicilan mulai', 'Rp 4 Jutaan'],
                    ...
                    <div style="padding:6px 0;">
                        ...
                        <div style="color:#1a237e; font-size:.95rem; margin-top:4px;">
                            Kaca Film, Seat Cover, Karpet Dasar, Paket Servis
                        </div>
                    </div>
            ...
            <div style="margin-top:15px; background:#e9ecef; border-radius:12px; padding:0; border:1px solid #d6d6d6; overflow:hidden;">
                ...
                <div style="padding:24px; font-size:15px; line-height:1.6; color:#5f6f7f; background:white;">
                    Informasi daftar harga diatas merupakan harga mobil baru Toyota New Innova yang sudah OTR ( On The Road ) Belum Dikurangi Cashback yang berlaku di Solo Raya Jawa Tengah
            ...
            {{-- PILIHAN WARNA --}}
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:10;">

                <h3 style="font-weight:700; color:#333; font-size:18px;">
                    <span style="border-left:3px solid #33ccff; padding-left:7px;">
                        PILIHAN WARNA NEW RUSH
                    </span>
                </h3>

                @php
                $warna = [
                ['gambar'=>'NewRush1.png','nama'=>'WARNA PUTIH TOYOTA...','caption'=>'Warna Putih Toyota New Rush GR Sport Solo Raya Jawa Tengah'],
                ['gambar'=>'NewRush2.png','nama'=>'WARNA DEEP MAROON MICA...','caption'=>'Warna Deep Maroon Mica Toyota New Rush GR Sport Solo Raya Jawa Tengah'],
                ['gambar'=>'NewRush3.png','nama'=>'WARNA DARK RED MICA METHALLIC...','caption'=>'Warna Dark Red Mica Metallic Toyota New Rush GR Sport Solo Raya Jawa Tengah'],
                ['gambar'=>'NewRush4.png','nama'=>'WARNA BLACK TOYOTA... ','caption'=>'Warna Black Mica Hitam Toyota New Rush GR Sport Solo Raya Jawa Tengah'],
                ];
                @endphp
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:10px;">
                ...
                <div class="ratio ratio-16x9 mb-3">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/j_JPN5HW9s8?autoplay=1&mute=1&rel=0"
                ...
                @php
                $videos = [
                ['id'=>'x0mXPifsxZM','title'=>'Review Toyota New Rush by OtoDriver'],
                ['id'=>'tGd1s4e-leM','title'=>'Review Test Drive Toyota New Rush by Carmudi'],
                ];
                @endphp
    ...
    ">
            ...
            <div class="card mt-2 shadow-sm" style="border-radius:14px;background:#ffffff;">
                <div class="card-body spec-box">
                    ...
                    <h4 style="font-weight:700; color:#333; font-size:18px;">
                        <span style="border-left:3px solid #33ccff; padding-left:7px;font-size:18px;">
                            REVIEW SPESIFIKASI NEW RUSH
                        </span>
                    </h4>


                    <p class="spec-text">
                        Sekarang, Toyota All New Rush mempunyai tampilan lebih sporty, elegan serta lebih nyaman digunakan bersama keluarga.
                    </p>

                    <p class="spec-text">
                        Hadir dengan 2 tipe TRD Sportivo dan tipe G, keduanya bermesin baru 2NR-VE, Dual VVT-i, yang diklaim bertenaga namun tetap irit bahan bakar minyak (BBM).
                    </p>

                    <p class="spec-subtitle">
                        Berikut fitur baru yang lebih lengkap dan lebih nyaman:
                    </p>
                    ...
                    <div id="specDetail" class="spec-detail">
                        ...
                        <!-- EKSTERIOR -->
                        <h6 class="spec-subtitle mt-3">Eksterior Toyota New Rush</h6>
                        <ul class="spec-list">
                            <li>Smoke headlamp with bi beam LED multireflektor</li>
                            <li>LED clearance lamp</li>
                            <li>Darkchrome grille</li>
                            <li>Ban 17 inc (TRD), 16 inc (type G)</li>
                            <li>Retractable Mirror with lamp</li>
                            <li>List chrome kaca samping (TRD)</li>
                            <li>LED rear lamp</li>
                            <li>Shark Fin antenna</li>
                            <li>New Spoiler</li>
                            <li>Parkir Sensor + Kamera</li>
                        </ul>
                        ...
                        <!-- INTERIOR -->
                        <h6 class="spec-subtitle mt-3">Interior Toyota New Rush</h6>
                        <ul class="spec-list">
                            <li>Smart entry (TRD)</li>
                            <li>Start-stop engine (all type)</li>
                            <li>Digital AC with memory (type G), Auto AC (TRD)</li>
                            <li>Softtouch panel (TRD)</li>
                            <li>7 inc monitor, USB, bluetooth, mirroring (type G) ditambah NFC + 8 Speaker (TRD)</li>
                            <li>Steering switch control</li>
                            <li>Tilt Steering</li>
                            <li>TFT MID Speedometer + Analog</li>
                            <li>5 Position seatbelt warning + Buzzer</li>
                            <li>3 Power outlet</li>
                        </ul>
                        ...
                        <ul class="spec-list">
                            ...
                            <li>HAC (Hill-start Assist Control)</li>
                            <li>6 Airbag</li>
                        </ul>

                        <!-- DISCLAIMER -->
                        <p class="spec-disclaimer mt-4">
                            <strong>Disclaimer:</strong> Tidak semua fitur New Toyota Rush ditampilkan dan dijelaskan di sini, untuk informasi lebih lengkap silakan melakukan test drive dengan menghubungi Marketing Toyota di website ini.
                        </p>
            ...
            <div class="card mt-2 shadow-sm p-4" style="background:white; border-radius:12px;">
                ...
                <div style="display:flex; gap:10px; overflow-x:auto; padding-top:10px;">
                    ...
                    @foreach($warna as $w)
                    <div style="min-width:260px; border-radius:0;">
                        <img
                            src="{{ asset('images/'.$w['gambar']) }}"
                            data-full="{{ asset('images/'.$w['gambar']) }}"
